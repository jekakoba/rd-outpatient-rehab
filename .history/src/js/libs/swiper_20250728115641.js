	...
	if (document.querySelectorAll('[data-swiper-carousel-reviews]').length > 0) {
		document.querySelectorAll('[data-swiper-carousel-reviews]').forEach(slider => {
			const config = {
				...
				cardsEffect: {
					rotate: true,
					perSlideRotate: 20, // Disable rotation for non-active slides
					perSlideOffset: 8, // Optional: Adjust offset between cards (default is 8)
					slideShadows: true, // Optional: Enable/disable shadows
				},
				// loop: true,
				grabCursor: true,
				autoplay: {
